    ...
    <div className="container mx-auto p-6 max-w-6xl">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Comprehensive testing suite untuk memverifikasi semua fungsionalitas admin panel
        </p>
      </div>
          ...
          <Card className="mb-6">
            ...
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold">{results.summary.success_rate}</div>
              ...
              <div className="border-t pt-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                  ...
                  <div>Vercel ENV: {results.environment.vercel_env || 'N/A'}</div>
                  <div>Database: {results.environment.has_database_url ? '✅' : '❌'}</div>
                  <div>Blob Token: {results.environment.has_blob_token ? '✅' : '❌'}</div>
                  <div>Admin Token: {results.environment.has_admin_token ? '✅' : '❌'}</div>
                  <div>Vercel URL: {results.environment.vercel_url || 'N/A'}</div>
                </div>
              </div>
            </CardContent>
          </Card>
